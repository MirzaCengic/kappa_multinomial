...
We start with an example to illustrate the use of $k_multinomial$. We proceed with some syntethic datasets to get insight in the behaviour of $k_multinomial$.
